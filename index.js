            ...
            this.getsession(() => {
                var data = {"D": JSON.stringify({
                                    ...
                                    "requests": [{
                                        ...
                                        "filters":[["datetime","D>=",datestart],["datetime","D<=",dateend],["rpc","=","Y"],["groupBy","=","day"],["dataType1","=","saleCount"],["dataType2","=","clickCountall"],["dataType3","=","saleCommission"],["rstatus","IN",status]]
                                    }],
                                    "S": _this.session
                                })};
